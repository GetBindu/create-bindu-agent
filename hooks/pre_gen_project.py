...
def display_skills_and_prompt() -> str:
    ...
    print(
        "\033[38;2;158;158;158mSelect skills to include in your agent (optional)\033[0m\n"
    )
    ...
    print(
        "\033[38;2;158;158;158mEnter skill numbers separated by spaces (e.g., '1 3 5'),"
    )
    ...
    if selection.lower() == "all":
        ...
        print(
            f"\033[38;2;102;187;106m✓\033[0m Selected all {len(selected_skills)} skills"
        )
    ...
    try:
        ...
        print(
            "\033[38;2;239;83;80m✗\033[0m Invalid input. Please enter numbers separated by spaces."
        )
        return ""

    if selected_skills:
        print(
            f"\033[38;2;102;187;106m✓\033[0m Selected {len(selected_skills)} skill(s)"
        )
        return ",".join(selected_skills)
